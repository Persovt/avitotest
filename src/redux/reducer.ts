...
export const reducer = (
  ...
  switch (action.type) {
    ...
    case SETFONTCOLOR:
      return Object.assign({}, state, { FontColor: action.Color });
    ...
    case REDIRECTIMAGE:
      if (isValidURL(action.RedirectURL))
        ...
        return Object.assign({}, state, { errorURL: "Uncorrect redirect url" });

    case CARDTEXT:
      return Object.assign({}, state, { cardText: action.cardText });
    default:
      return state;
  }
};
